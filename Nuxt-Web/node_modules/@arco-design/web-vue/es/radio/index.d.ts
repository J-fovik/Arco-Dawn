...
declare const Radio: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "modelValue" | "disabled" | "value" | "defaultChecked" | "uninjectGroupContext">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
