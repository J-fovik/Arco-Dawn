...
declare const Checkbox: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "modelValue" | "disabled" | "defaultChecked" | "indeterminate" | "uninjectGroupContext">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
