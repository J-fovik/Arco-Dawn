...
declare const Transfer: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "modelValue" | "disabled" | "defaultValue" | "data" | "title" | "simple" | "selected" | "showSearch" | "showSelectAll" | "defaultSelected" | "oneWay">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "update:modelValue", value: string[]) => void) & ((event: "select", selected: string[]) => void) & ((event: "change", value: string[]) => void) & ((event: "search", value: string, type: "source" | "target") => void) & ((event: "update:selected", selected: string[]) => void);
        $el: any;
