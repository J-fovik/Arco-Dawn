...
declare const List: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "size" | "scrollbar" | "loading" | "bordered" | "maxHeight" | "split" | "bottomOffset" | "hoverable">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
