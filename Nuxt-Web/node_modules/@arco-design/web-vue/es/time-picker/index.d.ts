...
declare const TimePicker: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "disabled" | "error" | "readonly" | "popupVisible" | "defaultPopupVisible" | "position" | "unmountOnClose" | "allowClear" | "format" | "disableConfirm" | "use12Hours" | "hideDisabledOptions">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "update:modelValue", timeString: string | (string | undefined)[] | undefined) => void) & ((event: "select", timeString: string | (string | undefined)[], time: Date | (Date | undefined)[]) => void) & ((event: "update:popupVisible", visible: boolean) => void) & ((event: "clear") => void) & ((event: "change", timeString: string | (string | undefined)[] | undefined, time: Date | (Date | undefined)[] | undefined) => void) & ((event: "popup-visible-change", visible: boolean) => void);
        $el: any;
