...
declare const AutoComplete: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "modelValue" | "disabled" | "defaultValue" | "data" | "strict" | "allowClear" | "filterOption">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "update:modelValue", value: string) => void) & ((event: "select", value: string) => void) & ((event: "clear", ev: Event) => void) & ((event: "change", value: string) => void) & ((event: "search", value: string) => void) & ((event: "dropdownScroll", ev: Event) => void) & ((event: "dropdownReachBottom", ev: Event) => void);
        $el: any;
