...
declare const Cascader: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "inputValue" | "disabled" | "error" | "defaultValue" | "popupVisible" | "defaultPopupVisible" | "multiple" | "allowClear" | "loading" | "allowSearch" | "maxTagCount" | "tagNowrap" | "defaultInputValue" | "options" | "valueKey" | "checkStrictly" | "pathMode" | "expandTrigger" | "searchOptionOnlyLabel" | "searchDelay" | "fallback" | "expandChild">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "inputValueChange", value: string) => void) & ((event: "focus", ev: FocusEvent) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "update:modelValue", value: string | number | Record<string, any> | (string | number | Record<string, any> | (string | number | Record<string, any>)[])[] | undefined) => void) & ((event: "update:popupVisible", visible: boolean) => void) & ((event: "popupVisibleChange", visible: boolean) => void) & ((event: "clear") => void) & ((event: "change", value: string | number | Record<string, any> | (string | number | Record<string, any> | (string | number | Record<string, any>)[])[] | undefined) => void) & ((event: "search", value: string) => void);
        $el: any;
