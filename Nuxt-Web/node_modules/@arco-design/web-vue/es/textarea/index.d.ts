...
declare const Textarea: {
    new (...args: any[]): {
        ...
        $emit: ((event: "focus", ev: FocusEvent) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "input", value: string, ev: Event) => void) & ((event: "update:modelValue", value: string) => void) & ((event: "clear", ev: MouseEvent) => void) & ((event: "change", value: string, ev: Event) => void);
        $el: any;
