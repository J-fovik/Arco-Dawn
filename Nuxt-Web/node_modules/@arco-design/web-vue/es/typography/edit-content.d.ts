declare const _default: import("vue").DefineComponent<{
    ...
    inputRef: import("vue").Ref<({
        new (...args: any[]): {
            ...
            } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "type" | "disabled" | "error" | "defaultValue" | "readonly" | "allowClear" | "maxLength" | "showWordLimit">;
            $attrs: {
                [x: string]: unknown;
            };
            $refs: {
            ...
            $emit: ((event: "focus", ev: FocusEvent) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "input", value: string, ev: Event) => void) & ((event: "update:modelValue", value: string) => void) & ((event: "clear", ev: MouseEvent) => void) & ((event: "change", value: string, ev: Event) => void) & ((event: "pressEnter", ev: KeyboardEvent) => void);
            $el: any;
