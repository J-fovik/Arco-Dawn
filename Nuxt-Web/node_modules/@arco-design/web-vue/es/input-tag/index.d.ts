...
declare const InputTag: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "retainInputValue" | "disabled" | "error" | "focused" | "uninjectFormItemContext" | "defaultValue" | "readonly" | "allowClear" | "maxTagCount" | "tagNowrap" | "defaultInputValue" | "uniqueValue" | "disabledInput">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "update:inputValue", inputValue: string) => void) & ((event: "inputValueChange", inputValue: string, ev: Event) => void) & ((event: "focus", ev: FocusEvent) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "update:modelValue", value: (string | number | import("./interface").TagData)[]) => void) & ((event: "clear", ev: MouseEvent) => void) & ((event: "change", value: (string | number | import("./interface").TagData)[], ev: Event) => void) & ((event: "remove", removed: string | number, ev: Event) => void) & ((event: "pressEnter", inputValue: string, ev: KeyboardEvent) => void);
        $el: any;
