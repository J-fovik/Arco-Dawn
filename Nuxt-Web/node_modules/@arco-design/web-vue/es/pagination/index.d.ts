...
declare const Pagination: {
    new (...args: any[]): {
        ...
        $emit: ((event: "change", current: number) => void) & ((event: "update:current", current: number) => void) & ((event: "pageSizeChange", pageSize: number) => void) & ((event: "update:pageSize", pageSize: number) => void);
        $el: any;
