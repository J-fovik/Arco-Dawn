...
var _Modal = _export_sfc(_sfc_main, [["render", _sfc_render]]);
...
var open = (config, appContext) => {
  ...
  const vm = createVNode(_Modal, __spreadValues2(__spreadValues2(__spreadValues2({}, defaultConfig), omit(config, ["content", "title", "footer", "visible", "unmountOnClose", "onOk", "onCancel", "onClose"])), {
...
var modal = __spreadValues2({
  open,
  confirm: (config, appContext) => {
    const _config = __spreadValues2({
      simple: true,
      messageType: "warning"
    }, config);
...
var Modal = Object.assign(_Modal, __spreadProps(__spreadValues2({}, modal), {
  install: (app, options) => {
...
//# sourceMappingURL=chunk-ORTIYR6O.js.map
