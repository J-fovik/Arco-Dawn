...
export { type AddonsOptions as A, type BuiltinPresetName as B, type Import as I, type MagicStringResult as M, type Preset as P, type ScanDirExportsOptions as S, type TypeDeclarationOptions as T, type UnimportOptions as U, type InlinePreset as a, type Thenable as b, type InjectImportsOptions as c, type ImportInjectionResult as d, type UnimportMeta as e, type UnimportContext as f, type InstallGlobalOptions as g, builtinPresets as h, type ModuleId as i, type ImportName as j, type ImportCommon as k, type PresetImport as l, type PackagePreset as m, type InjectionUsageRecord as n, type PathFromResolver as o, type Addon as p };
