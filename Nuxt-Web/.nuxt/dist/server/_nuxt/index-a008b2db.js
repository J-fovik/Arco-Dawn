...
const downloadBlob = (res, name) => {
  ...
  downloadElement.download = decodeURI((name == null ? void 0 : name.replace(/%/g, "%25")) ?? "");
...
export {
  ...
  downloadBlob as d,
  formatDate as f,
  groupByAndMergeChildArrays as g,
  hidePhoneFormat as h,
  sleep as s,
  textFormat as t
};
//# sourceMappingURL=index-a008b2db.js.map
