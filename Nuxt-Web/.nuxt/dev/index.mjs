globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, getQuery as getQuery$1, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getResponseStatusText } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/devalue/index.js';
import { renderToString } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/ofetch/dist/node.mjs';
import destr from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/scule/dist/index.mjs';
import { klona } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/radix3/dist/index.mjs';
import { basename } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/@iconify/utils/lib/index.mjs';
import { consola } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/unenv/runtime/npm/consola.mjs';
import { collections } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/.nuxt/nuxt-icon-server-bundle.mjs';
import { version, unref } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/yue/Arco-Dawn/Nuxt-Web/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/yue/Arco-Dawn/Nuxt-Web/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\yue\\Arco-Dawn\\Nuxt-Web","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\yue\\Arco-Dawn\\Nuxt-Web\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\yue\\Arco-Dawn\\Nuxt-Web\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\yue\\Arco-Dawn\\Nuxt-Web\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\yue\\Arco-Dawn\\Nuxt-Web\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _wlIxlA = defineCachedEventHandler(async (event) => {
...
const _lazy_cocFTx = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_cocFTx, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _wlIxlA, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_cocFTx, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1, maximum-scale=1.0, user-scalable=0"},{"charset":"utf-8"},{"name":"keywords","content":"高考报名，填报"},{"name":"description","content":""}],"link":[{"rel":"stylesheet","href":"/images/icon.png"}],"style":[],"script":[],"noscript":[],"charset":"utf-8","viewport":"width=device-width, initial-scale=1, maximum-scale=1.0, user-scalable=0","titleTemplate":"毕业之家升学规划"};
...
const getClientManifest = () => import('file://D:/yue/Arco-Dawn/Nuxt-Web/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/yue/Arco-Dawn/Nuxt-Web/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
