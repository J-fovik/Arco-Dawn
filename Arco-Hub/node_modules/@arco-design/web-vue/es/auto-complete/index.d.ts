...
declare const AutoComplete: {
    new (...args: any[]): {
        ...
        $emit: ((event: "clear", ev: Event) => void) & ((event: "select", value: string) => void) & ((event: "update:modelValue", value: string) => void) & ((event: "change", value: string) => void) & ((event: "search", value: string) => void) & ((event: "dropdownScroll", ev: Event) => void) & ((event: "dropdownReachBottom", ev: Event) => void);
        $el: any;
