...
declare const VerificationCode: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "length" | "disabled" | "error" | "defaultValue" | "readonly" | "masked">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "input", inputValue: string, index: number, ev: Event) => void) & ((event: "update:modelValue", value: string) => void) & ((event: "change", value: string) => void) & ((event: "finish", value: string) => void);
        $el: any;
