...
declare const Form: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "layout" | "labelColProps" | "wrapperColProps" | "labelAlign" | "autoLabelWidth" | "scrollToFirstError">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
